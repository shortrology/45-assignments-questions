...
let frientsName : string[] = ["bilal","umer","hani","maha","bushra"]
...
let memberName : string[] = ["saba","azam","sana","bushra","hani"]
...
let transportation : string[] =  ["civic","bike","bus","suzuki","rikshaw",]
...
let GuestListName: string [] = ["Ali","sarah","omer","fatima","ahemd"]
